...
func (f factory) StateInitializer(c client.Client, main, variables string, tfVars []byte, state string) Initializer {
	return StateInitializer(c, main, variables, tfVars, state)
}
