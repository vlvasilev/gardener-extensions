...
func AddWithOptions(mgr manager.Manager, opts controller.Options, machineImages []config.MachineImage) error {
	return worker.Add(mgr, worker.AddArgs{
		Actuator:          NewActuator(machineImages),
		Type:              aws.Type,
...
func Add(mgr manager.Manager) error {
	return AddWithOptions(mgr, Options, MachineImages)
}
